...
var button = d3.selectAll(".filter").on("change", filterfunction);
...
function filterfunction() {
    ...
    var inputInfo = inputElement.property("value");
    console.log(inputInfo)
        //Figuring out the id for the value
    var inputID = inputElement.attr("id");
    console.log(inputID)
        //filter data for the date value to get data that is searched for
    var filteredData = tableData.filter(UFOsighting => UFOsighting[inputID] === inputInfo);
...
//     //get the value property of the input element
//     var inputDate = inputElement.property("id");
